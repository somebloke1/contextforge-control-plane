...
if ! grep -q '^\[mcp_servers\.contextforge-helper\]$' "${config_path}"; then
  {
    ...
    printf 'cwd = "/repo"\n'
    printf 'env = { CONTEXTFORGE_HELPER_DEFAULT_CLIENT_TYPE = "codex", CONTEXTFORGE_HELPER_REQUIRE_USER_APPROVAL_TEXT = "1", CONTEXTFORGE_HELPER_PYTHON = "%s", CONTEXTFORGE_HELPER_SCRIPT = "%s", CONTEXTFORGE_PROJECT_INIT_USE_DEV_DOCKER_VIRTUAL_SERVER = "%s", CONTEXTFORGE_PROJECT_INIT_RUN_ROOT = "%s", CONTEXTFORGE_HELPER_APPROVAL_SOURCE_PATH = "%s", CONTEXTFORGE_ADDITIONAL_SAFE_PROJECT_ROOTS = "%s", CONTEXTFORGE_CODEX_WRAPPER_PYTHON = "%s", CONTEXTFORGE_CODEX_WRAPPER_SCRIPT = "%s", CONTEXTFORGE_CODEX_WRAPPER_CONFIG_ENV = "%s", CONTEXTFORGE_CODEX_WRAPPER_BASE_URL = "%s", CONTEXTFORGE_CODEX_WRAPPER_TOKEN_CACHE = "%s" }\n' \
      "${CONTEXTFORGE_HELPER_PYTHON}" \
      "${CONTEXTFORGE_HELPER_SCRIPT}" \
      "${CONTEXTFORGE_PROJECT_INIT_USE_DEV_DOCKER_VIRTUAL_SERVER}" \
...
export CONTEXTFORGE_PROJECT_INIT_USE_DEV_DOCKER_VIRTUAL_SERVER
