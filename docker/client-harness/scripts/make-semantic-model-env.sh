...
umask 077
{
  ...
  printf 'OPENROUTER_MODEL=%s\n' "${OPENROUTER_MODEL:-${CONTEXTFORGE_TEST_MODEL:-google/gemma-4-26b-a4b-it}}"
  printf 'OPENROUTER_OPENCODE_MODEL=%s\n' "${OPENROUTER_OPENCODE_MODEL:-${CONTEXTFORGE_TEST_MODEL:-google/gemma-4-26b-a4b-it}}"
  printf 'OPENROUTER_PROVIDER_ROUTE=%s\n' "${OPENROUTER_PROVIDER_ROUTE:-${CONTEXTFORGE_TEST_PROVIDER_ROUTE:-}}"
  printf 'OPENROUTER_PROVIDER_ROUTES=%s\n' "${OPENROUTER_PROVIDER_ROUTES:-${OPENROUTER_PROVIDER_ROUTE:-${CONTEXTFORGE_TEST_PROVIDER_ROUTE:-}}}"
  ...
  printf 'CONTEXTFORGE_PI_DEFAULT_MODEL=%s\n' "${CONTEXTFORGE_PI_DEFAULT_MODEL:-${OPENROUTER_MODEL:-${CONTEXTFORGE_TEST_MODEL:-google/gemma-4-26b-a4b-it}}}"
  printf 'CONTEXTFORGE_OPENCODE_DEFAULT_MODEL=%s\n' "${CONTEXTFORGE_OPENCODE_DEFAULT_MODEL:-openrouter/${OPENROUTER_OPENCODE_MODEL:-${CONTEXTFORGE_TEST_MODEL:-google/gemma-4-26b-a4b-it}}}"
