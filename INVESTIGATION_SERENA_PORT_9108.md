...
1. **Canonical instance** (operator repo): `server-instances/serena-context-portal/` uses **hardcoded port 9108** and is a singleton
...
**Directory:** `server-instances/serena-context-portal/`
...
If someone tries to **regenerate or move** the canonical `serena-context-portal` instance through the per-project system:
...
The canonical `server-instances/serena-context-portal/run-server.sh` is **separate and manual**, not affected by the per-project generation logic.
...
**Action:** Add a note to `server-instances/serena-context-portal/README.md` clarifying:
...
**File to update:** `server-instances/serena-context-portal/README.md`
...
1. **Single canonical instance** (`serena-context-portal`):
...
1. Update `server-instances/serena-context-portal/README.md` with status clarification
...
- `server-instances/serena-context-portal/` (Canonical instance)
- `server-instances/serena-context-portal/instance.json` (Port 9108 assignment)
